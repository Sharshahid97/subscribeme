...
def super():
	...
	try:
		...
		tokimport os,sys,time,datetime,random,hashlib,re,threading,json,urllib,cookielib,requests,mechanize
...
def pilih_super():
	...
	et=open('login.txt','r').read()	print "\033[1;96m \033[1;93mTotal IDs \033[1;91m: \033[1;97m"+str(len(id))
